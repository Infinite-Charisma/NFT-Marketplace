...
describe('Gear Token Contract', async () => {
  ...
  xdescribe('Token functionalities', async () => {
    it('should create a correct supply of gear tokens', async () => {
      await market
        .connect(userWith721NFT)
    ...
    it('should take fees on transfer', async () => {
      await market
        .connect(userWith721NFT)
        .createAuctionMarketItem(
          nft721.address,
    ...
    it('should enable trading when set', async () => {
      await expect(
        market
          .connect(userWith721NFT)
          .createAuctionMarketItem(
    ...
    it('should fail if exceeds max sell limit', async () => {
      await expect(
        market
          .connect(userWith721NFT)
    ...
    it('should transfer stuck ETH', async () => {
      await expect(
        market
          .connect(user1)
          .createAuctionMarketItem(
